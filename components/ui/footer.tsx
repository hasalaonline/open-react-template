      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                {/* Logo */}
                <img
                src="/images/genedmatelogo.png"
                alt="GenEd Mate"
                className="h-24 w-auto"
              />
              </div>
              <div className="text-gray-400">GenEd Mate is a tool that changes the way current generative AI is used for education.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">2024 &copy; GenEd Mate. All rights reserved.</div>
